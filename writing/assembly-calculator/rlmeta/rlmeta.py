...
class Parser(_Grammar):
    ...
    def __init__(self):
        ...
        I('LIST_END')
        I('BIND', 'ys')
        I('ACTION', lambda scope: _makeList([(0, 'Integer'), (0, int(join(_makeList([(0, scope['y'].eval()), (1, scope['ys'].eval())])), scope['x'].eval()))]))
        I('POP_SCOPE')
        I('COMMIT', 53)
        LABEL(52)
        I('BACKTRACK', 50)
        ...
        I('PUSH_SCOPE')
        I('MATCH_CHARSEQ', '0x')
        I('ACTION', lambda scope: 8)
        I('POP_SCOPE')
        I('COMMIT', 93)
        LABEL(92)
        I('PUSH_SCOPE')
        I('ACTION', lambda scope: 10)
        I('POP_SCOPE')
        LABEL(93)
        I('RETURN')
