...
class Parser(Grammar):
    ...
    labels = {'file': 0, 0: 2, 1: 13, 2: 23, 3: 25, 'grammar': 29, 4: 39, 5: 46, 'rule': 57, 'choice': 74, 6: 85, 7: 85, 8: 90, 9: 103, 'sequence': 110, 10: 112, 11: 119, 'expr': 130, 12: 150, 13: 154, 'expr1': 155, 14: 171, 16: 187, 18: 203, 20: 215, 21: 219, 19: 219, 17: 219, 15: 219, 'expr2': 220, 24: 237, 25: 239, 22: 244, 26: 264, 30: 272, 32: 281, 33: 283, 31: 289, 28: 299, 34: 311, 36: 331, 38: 337, 39: 344, 37: 354, 35: 354, 29: 354, 27: 354, 23: 354, 'matchChar': 355, 'maybeAction': 364, 40: 376, 41: 380, 'actionExpr': 381, 44: 406, 45: 410, 42: 421, 43: 435, 'hostExpr': 436, 46: 450, 50: 458, 51: 465, 48: 477, 54: 485, 55: 492, 52: 504, 58: 516, 59: 523, 56: 535, 57: 541, 53: 541, 49: 541, 47: 541, 'hostListItem': 542, 60: 546, 61: 553, 'formatExpr': 564, 64: 572, 65: 579, 62: 591, 63: 595, 'var': 596, 66: 612, 68: 627, 69: 629, 67: 632, 'string': 633, 70: 637, 72: 646, 73: 648, 71: 654, 'char': 663, 74: 672, 75: 674, 'innerChar': 684, 76: 694, 77: 697, 'escape': 698, 78: 708, 80: 718, 82: 728, 83: 734, 81: 734, 79: 734, 'name': 735, 84: 743, 85: 750, 'nameStart': 757, 86: 766, 87: 771, 'nameChar': 772, 88: 781, 90: 790, 91: 795, 89: 795, 'space': 796, 92: 798, 94: 808, 95: 812, 93: 815}
    instructions = [
        PUSH_SCOPE,
        LIST_START,
        BACKTRACK,
...
class Assembler(Grammar):
    ...
    labels = {'Grammar': 0, 0: 5, 1: 12, 'Rule': 19, 'Target': 27, 'Label': 35, 'I': 43, 'Expr': 51, 'Action': 60, 'Set': 69, 'String': 86, 'List': 91, 'ListItem': 100, 'Format': 113, 'Indent': 122, 'Call': 131, 'Native': 144, 'Lookup': 148, 'asts': 157, 2: 159, 3: 166, 4: 174, 5: 176, 'astList': 180, 6: 182, 7: 189, 'ast': 196, 'py': 206}
    instructions = [
        PUSH_SCOPE,
        MATCH_ANY,
        BIND,
        ...
        'x',
        ACTION,
        lambda self: self.lookup('LABEL')(self.lookup('x'), len(self.lookup('I'))),
        POP_SCOPE,
        RETURN,
        PUSH_SCOPE,
        MATCH_ANY,
        ...
        'x',
        ACTION,
        lambda self: self.lookup('I')(repr(self.lookup('x'))),
        POP_SCOPE,
        RETURN,
        PUSH_SCOPE,
        MATCH_ANY,
        ...
        'x',
        ACTION,
        lambda self: self.lookup('I')(self.lookup('x')),
        POP_SCOPE,
        RETURN,
        PUSH_SCOPE,
        CALL,
        ...
        'x',
        ACTION,
        lambda self: self.lookup('I')(join(['lambda self: ', self.lookup('x')])),
        POP_SCOPE,
        RETURN,
        PUSH_SCOPE,
        CALL,
