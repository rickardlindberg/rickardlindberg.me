...
class CodeGenerator(Grammar):
    ...
    labels = {'Grammar': 0, 0: 5, 1: 12, 'Rule': 19, 'Or': 31, 2: 47, 3: 51, 'Scope': 52, 'And': 61, 4: 63, 5: 70, 'Bind': 77, 'Star': 89, 'Not': 98, 'MatchCallRule': 107, 'MatchRule': 112, 'MatchRange': 120, 'MatchAny': 131, 'MatchList': 136, 'MatchObject': 145, 'Action': 153, 6: 155, 7: 161, 'asts': 168, 8: 170, 9: 177, 10: 185, 11: 187, 'ast': 191}
    instructions = [
        PUSH_SCOPE,
        MATCH_ANY,
        BIND,
        ...
        'xs',
        ACTION,
        lambda self: concat([splice(0, concat([splice(0, 'I'), splice(0, 'ACTION')])), splice(0, concat([splice(0, 'Action'), splice(0, self.lookup('xs'))]))]),
        POP_SCOPE,
        RETURN,
        PUSH_SCOPE,
        LIST_START,
...
class Assembler(Grammar):
    ...
    labels = {'Grammar': 0, 0: 5, 1: 12, 'Rule': 19, 'Target': 27, 'Label': 35, 'I': 43, 'Expr': 51, 'Action': 60, 'actionExpr': 71, 2: 91, 3: 96, 'String': 97, 'List': 102, 'ListItem': 111, 'Format': 124, 'Indent': 133, 'Call': 142, 'Native': 155, 'Lookup': 159, 'asts': 168, 4: 170, 5: 177, 6: 185, 7: 187, 'astList': 191, 8: 193, 9: 200, 'ast': 207, 'py': 217}
    instructions = [
        PUSH_SCOPE,
        MATCH_ANY,
        BIND,
