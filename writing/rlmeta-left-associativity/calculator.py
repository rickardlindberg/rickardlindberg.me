                    ...
                    (lambda _vars:
                        (lambda:
                            self._and([
                                                    ...
                                                    (lambda _vars:
                                                        (lambda:
                                                            self._and([
                                                                ...
                                                                (lambda:
                                                                    _SemanticAction(lambda: ([_vars.lookup('y').eval()]+[_vars.lookup('z').eval()]+[]))
                                                                ),
                                                            ])
                                                        )()
                                                    )(_Vars())
                                ...
                                (lambda:
                                    _SemanticAction(lambda: leftAssoc(
                                        _vars.lookup('x').eval(),
