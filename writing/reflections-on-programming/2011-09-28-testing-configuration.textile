...
A while ago I fixed a bug in "simple review":https://github.com/rickardlindberg/simple-review that had to do with escaping. The problem was that not all characters were escaped when converting a Python string to a JSON string.
