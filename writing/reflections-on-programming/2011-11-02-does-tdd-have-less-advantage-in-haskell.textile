...
In Haskell ("which I'm currently learning":/writing/reflections-on-programming/2011-10-10-learning-haskell/index.html ) you make a distinction between pure and impure functions. Pure functions do not have side effects and they always return the same value when called with the same arguments. Pure functions are therefore easy to test.
