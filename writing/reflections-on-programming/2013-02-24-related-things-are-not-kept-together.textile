...
!leo-photobox-file-structure.png(Replicated file structure in Leo.)!
...
!leo-photobox-class-structure.png(Show structure inside files.)!
...
!leo-photobox-class-structure-grouping.png(Create more structure inside files.)!
...
!leo-photobox-clones.png(Using clones to create different views.)!
...
!leo-photobox-another-view.png(Using clones to create different views.)!
