...
In this post I explain how I got started writing code for the "file organization application":/writing/reflections-on-programming/2012-01-11-application-development-series-intro/index.html. I describe the first two commits and the thoughts behind them.
