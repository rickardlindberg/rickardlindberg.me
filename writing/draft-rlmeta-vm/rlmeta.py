...
class CodeGenerator(_Program):
    def __init__(self):
        ...
        I('CALL', 'ast')
        I('BIND', 'y')
        I('ACTION', lambda env: _Builder.create(['LABEL(', repr(env['x'].eval()), ')\n', env['y'].eval(), "I('RETURN')\n"]))
        I('POP_SCOPE')
        I('RETURN')
        LABEL('MatchAny')
        I('PUSH_SCOPE')
        ...
        I('MATCH_ANY')
        I('BIND', 'x')
        I('ACTION', lambda env: _Builder.create([repr(env['x'].eval())]))
        I('POP_SCOPE')
        I('RETURN')
        LABEL('List')
        I('PUSH_SCOPE')
        ...
        I('MATCH_ANY')
        I('BIND', 'x')
        I('ACTION', lambda env: _Builder.create(['env[', repr(env['x'].eval()), '].eval()']))
        I('POP_SCOPE')
        I('RETURN')
        LABEL('Or')
        I('BACKTRACK', 4)
        ...
        I('CALL', 'ast')
        I('BIND', 'y')
        I('ACTION', lambda env: _Builder.create([env['y'].eval(), "I('BIND', ", repr(env['x'].eval()), ')\n']))
        I('POP_SCOPE')
        I('RETURN')
        LABEL('Star')
        I('PUSH_SCOPE')
        ...
        I('MATCH_ANY')
        I('BIND', 'x')
        I('ACTION', lambda env: _Builder.create(["I('CALL', ", repr(env['x'].eval()), ')\n']))
        I('POP_SCOPE')
        I('RETURN')
        LABEL('MatchRange')
        I('PUSH_SCOPE')
        ...
        I('MATCH_ANY')
        I('BIND', 'y')
        I('ACTION', lambda env: _Builder.create(["I('MATCH_RANGE', ", repr(env['x'].eval()), ', ', repr(env['y'].eval()), ')\n']))
        I('POP_SCOPE')
        I('RETURN')
        LABEL('MatchString')
        I('PUSH_SCOPE')
        I('MATCH_ANY')
        I('BIND', 'x')
        I('ACTION', lambda env: _Builder.create(["I('MATCH_STRING', ", repr(env['x'].eval()), ')\n']))
        I('POP_SCOPE')
        I('RETURN')
        LABEL('MatchCharseq')
        I('PUSH_SCOPE')
        I('MATCH_ANY')
        I('BIND', 'x')
        I('ACTION', lambda env: _Builder.create(["I('MATCH_CHARSEQ', ", repr(env['x'].eval()), ')\n']))
        I('POP_SCOPE')
        I('RETURN')
        LABEL('MatchList')
        I('PUSH_SCOPE')
