...
class CodeGenerator(_Program):
    def _load(self):
        ...
        self._instruction('CALL', 'astItem')
        self._instruction('LIST_APPEND')
        self._instruction('COMMIT', 8)
        self._label(9)
        self._instruction('LIST_END')
        self._instruction('BIND', 'xs')
        self._instruction('ACTION', lambda env: _Builder.create([env['x'].eval(), env['xs'].eval()]))
        self._instruction('POP_SCOPE')
        self._instruction('COMMIT', 11)
        self._label(10)
        self._instruction('PUSH_SCOPE')
        ...
        self._instruction('LIST_START')
        self._label(12)
        self._instruction('BACKTRACK', 13)
        self._instruction('CALL', 'astListItem')
        self._instruction('LIST_APPEND')
        self._instruction('COMMIT', 12)
        self._label(13)
        self._instruction('LIST_END')
        self._instruction('BIND', 'xs')
