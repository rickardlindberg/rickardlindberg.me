...
class Parser(Grammar):
    ...
    def assemble(self, I, LABEL):
        ...
        I('CALL', 'space')
        I('MATCH_OBJECT', '}')
        I('ACTION', lambda scope: concat([splice(0, 'Grammar'), splice(0, scope['x'].eval()), splice(1, scope['ys'].eval())]))
        I('POP_SCOPE')
        I('RETURN')
        LABEL('rule')
        I('PUSH_SCOPE')
        ...
        I('CALL', 'choice')
        I('BIND', 'y')
        I('ACTION', lambda scope: concat([splice(0, 'Rule'), splice(0, scope['x'].eval()), splice(0, scope['y'].eval())]))
        I('POP_SCOPE')
        I('RETURN')
        LABEL('choice')
        I('PUSH_SCOPE')
        ...
        I('LIST_END')
        I('BIND', 'xs')
        I('ACTION', lambda scope: concat([splice(0, 'Or'), splice(0, scope['x'].eval()), splice(1, scope['xs'].eval())]))
        I('POP_SCOPE')
        I('RETURN')
        LABEL('sequence')
        I('PUSH_SCOPE')
        ...
        I('LIST_END')
        I('BIND', 'xs')
        I('ACTION', lambda scope: concat([splice(0, 'Scope'), splice(0, concat([splice(0, 'And'), splice(0, scope['x'].eval()), splice(1, scope['xs'].eval())]))]))
        I('POP_SCOPE')
        I('RETURN')
        LABEL('expr')
        I('BACKTRACK', 8)
        ...
        I('CALL', 'name')
        I('BIND', 'y')
        I('ACTION', lambda scope: concat([splice(0, 'Bind'), splice(0, scope['y'].eval()), splice(0, scope['x'].eval())]))
        I('POP_SCOPE')
        I('COMMIT', 9)
        LABEL(8)
        I('PUSH_SCOPE')
        ...
        I('CALL', 'space')
        I('MATCH_OBJECT', '*')
        I('ACTION', lambda scope: concat([splice(0, 'Star'), splice(0, scope['x'].eval())]))
        I('POP_SCOPE')
        I('COMMIT', 19)
        LABEL(18)
        I('BACKTRACK', 16)
        ...
        I('CALL', 'space')
        I('MATCH_OBJECT', '?')
        I('ACTION', lambda scope: concat([splice(0, 'Or'), splice(0, scope['x'].eval()), splice(0, concat([splice(0, 'And')]))]))
        I('POP_SCOPE')
        I('COMMIT', 17)
        LABEL(16)
        I('BACKTRACK', 14)
        ...
        I('CALL', 'expr2')
        I('BIND', 'x')
        I('ACTION', lambda scope: concat([splice(0, 'Not'), splice(0, scope['x'].eval())]))
        I('POP_SCOPE')
        I('COMMIT', 15)
        LABEL(14)
        I('BACKTRACK', 12)
        ...
        I('CALL', 'space')
        I('MATCH_OBJECT', '#')
        I('ACTION', lambda scope: concat([splice(0, 'Label')]))
        I('POP_SCOPE')
        I('COMMIT', 11)
        LABEL(10)
        I('PUSH_SCOPE')
        ...
        I('CALL', 'hostExpr')
        I('BIND', 'x')
        I('ACTION', lambda scope: concat([splice(0, 'SemanticAction'), splice(0, scope['x'].eval())]))
        I('POP_SCOPE')
        I('COMMIT', 35)
        LABEL(34)
        I('BACKTRACK', 32)
        ...
        LABEL(21)
        I('ACTION', lambda scope: concat([splice(0, 'MatchRule'), splice(0, scope['x'].eval())]))
        I('POP_SCOPE')
        I('COMMIT', 33)
        LABEL(32)
        I('BACKTRACK', 30)
        ...
        I('CALL', 'char')
        I('BIND', 'y')
        I('ACTION', lambda scope: concat([splice(0, 'MatchRange'), splice(0, scope['x'].eval()), splice(0, scope['y'].eval())]))
        I('POP_SCOPE')
        I('COMMIT', 31)
        LABEL(30)
        I('BACKTRACK', 28)
        ...
        I('CALL', 'space')
        I('MATCH_OBJECT', ']')
        I('ACTION', lambda scope: concat([splice(0, 'MatchList'), splice(0, concat([splice(0, 'And'), splice(1, scope['xs'].eval())]))]))
        I('POP_SCOPE')
        LABEL(25)
        LABEL(27)
        LABEL(29)
        ...
        I('CALL', 'string')
        I('BIND', 'x')
        I('ACTION', lambda scope: concat([splice(0, 'String'), splice(0, scope['x'].eval())]))
        I('POP_SCOPE')
        I('COMMIT', 49)
        LABEL(48)
        I('BACKTRACK', 46)
        ...
        I('CALL', 'space')
        I('MATCH_OBJECT', ']')
        I('ACTION', lambda scope: concat([splice(0, 'List'), splice(1, scope['xs'].eval())]))
        I('POP_SCOPE')
        I('COMMIT', 47)
        LABEL(46)
        I('BACKTRACK', 44)
        ...
        I('CALL', 'space')
        I('MATCH_OBJECT', '}')
        I('ACTION', lambda scope: concat([splice(0, 'Format'), splice(1, scope['xs'].eval())]))
        I('POP_SCOPE')
        I('COMMIT', 45)
        LABEL(44)
        I('BACKTRACK', 42)
        ...
        I('CALL', 'space')
        I('MATCH_OBJECT', ')')
        I('ACTION', lambda scope: concat([splice(0, 'FnCall'), splice(0, scope['x'].eval()), splice(1, scope['ys'].eval())]))
        I('POP_SCOPE')
        I('COMMIT', 43)
        LABEL(42)
        I('PUSH_SCOPE')
        I('CALL', 'name')
        I('BIND', 'x')
        I('ACTION', lambda scope: concat([splice(0, 'VarLookup'), splice(0, scope['x'].eval())]))
        I('POP_SCOPE')
        LABEL(43)
        LABEL(45)
        LABEL(47)
        ...
        I('CALL', 'hostExpr')
        I('BIND', 'x')
        I('ACTION', lambda scope: concat([splice(0, 'ListItem'), splice(0, len(scope['ys'].eval())), splice(0, scope['x'].eval())]))
        I('POP_SCOPE')
        I('RETURN')
        LABEL('formatExpr')
        I('BACKTRACK', 54)
        ...
        I('CALL', 'space')
        I('MATCH_OBJECT', '<')
        I('ACTION', lambda scope: concat([splice(0, 'Indent'), splice(0, concat([splice(0, 'Format'), splice(1, scope['xs'].eval())]))]))
        I('POP_SCOPE')
        I('COMMIT', 55)
        LABEL(54)
        I('PUSH_SCOPE')
        ...
        I('BIND', 'xs')
        I('MATCH_OBJECT', "'")
        I('ACTION', lambda scope: concat([splice(0, 'And'), splice(1, scope['xs'].eval())]))
        I('POP_SCOPE')
        I('RETURN')
        LABEL('matchChar')
        I('PUSH_SCOPE')
        I('CALL', 'innerChar')
        I('BIND', 'x')
        I('ACTION', lambda scope: concat([splice(0, 'MatchObject'), splice(0, scope['x'].eval())]))
        I('POP_SCOPE')
        I('RETURN')
        LABEL('string')
        I('PUSH_SCOPE')
...
class CodeGenerator(Grammar):
    ...
    def assemble(self, I, LABEL):
        ...
        I('CALL', 'py')
        I('BIND', 'x')
        I('ACTION', lambda scope: join(["I('MATCH_OBJECT', ", scope['x'].eval(), ')\n']))
        I('POP_SCOPE')
        I('RETURN')
        LABEL('MatchAny')
        I('PUSH_SCOPE')
        ...
        I('CALL', 'astItems')
        I('BIND', 'x')
        I('ACTION', lambda scope: join(['concat([', scope['x'].eval(), '])']))
        I('POP_SCOPE')
        I('RETURN')
        LABEL('ListItem')
        I('PUSH_SCOPE')
        ...
        I('CALL', 'ast')
        I('BIND', 'y')
        I('ACTION', lambda scope: join(['splice(', scope['x'].eval(), ', ', scope['y'].eval(), ')']))
        I('POP_SCOPE')
        I('RETURN')
        LABEL('Format')
        I('PUSH_SCOPE')
